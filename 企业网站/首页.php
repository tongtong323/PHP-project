...
<div class="body">
    <div id="top">
        <div id="top_right">
            <ul>
                <li><a href="首页.php">首页</a></li>
                <li><a href="关于我们.php">关于我们</a></li>
                <li><a href="新闻资讯.php">新闻资讯</a></li>
                <li><a href="产品展示.php">产品展示</a></li>
                <li><a href="联系我们.php">联系我们</a></li>
            </ul>
        </div>
    ...
    <div class="product">
        ...
        if (!empty($res)) {
            ...
            //?>
            <div class="product">
                <div class="product_1"><a href="#"><img src="http://img.php.cn/upload/course/000/000/010/58240805c0a89281.png" width="80" height="90"></a></div>
    ...
    <div class="info">
        <div class="info_right">
            ...
            while($row1 = mysqli_fetch_array($res1)){
                ?>
                <div><?php echo $row1['title'];?>
                    <span><?php echo date('y-m-d',$row1['newtime']);?></span></div>
                <?php
            }
            ?>
        </div>
